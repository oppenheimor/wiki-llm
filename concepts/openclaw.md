...
后续安全分析把 OpenClaw 当成一个典型案例来讨论：当 Agent 同时拥有高权限文件/命令能力、外部通信能力、并会处理不可信网页内容时，风险会迅速放大。这个视角的重点不只是“某个工具是否危险”，而是 [[concepts/agent-iam]] 所说的身份传播、无秘钥验证与上下文授权是否做对。
...
但这也意味着一个现实前提：OpenClaw 想稳定发挥“主动工作”“手机遥控”“随时在线”的价值，背后必须有一台持续供电、联网、不中断的宿主机。Gateway 是长期运行的控制中枢，如果宿主机掉线，OpenClaw 的主动能力就会跟着静止。
...
- 微信公众号：《OpenClaw的启示：身份权限管理是AI Agent时代的阿喀琉斯之踵》（2026-04-15）
