...
### 公开流传的系统提示词可作为工作流旁证，但不应当被当作官方规范
用户粘贴文章援引了 GitHub 仓库 `elder-plinius/CL4R1T4S` 收录的 `Claude-Design-Sys-Prompt.txt`。这类文本更适合拿来理解 Claude Design 为什么会强调“先拿设计上下文、再做变体探索、尽量避免从零硬拟完整产品”，但稳定事实仍应以 Anthropic 官方新闻、帮助中心与 Cookbook 为准。
...
- 想主动规避生成式 UI 的“平均审美”时，把它与 [[patterns/anti-ai-slop-frontend-prompting]] 这类提示策略组合使用
...
- GitHub 仓库 `elder-plinius/CL4R1T4S` 中公开收录的 `Claude-Design-Sys-Prompt.txt` 快照：https://github.com/elder-plinius/CL4R1T4S/blob/main/ANTHROPIC/Claude-Design-Sys-Prompt.txt
